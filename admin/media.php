...
<div class="card">
  ...
  <p class="form-hint" style="margin-bottom:1rem;">Nahraný obrázek zkopírujte a jeho cestu vložte do textového pole s HTML obsahu, nebo do pole obrázku ve stránkovém editoru.</p>
