...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  flash('Stránka „Advokátní úschova“ byla uložena a je ihned vidět na webu.');
  header('Location: /admin/content-advokatni.php');
  exit;
}

$c = fuContent('advokatni_uschova');
adminHeader('Advokátní úschova', 'content-advokatni');
?>
