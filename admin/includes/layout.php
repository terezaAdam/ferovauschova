...
<head>
  ...
  <title><?= htmlspecialchars($title) ?> – Férová úschova Admin</title>
...
<div class="admin-layout">
  ...
  <aside class="sidebar" role="navigation" aria-label="Admin menu">
    <div class="sidebar__brand">
      <div class="sidebar__brand-name">FÉROVÁ ÚSCHOVA</div>
    ...
    <nav class="sidebar__nav">
      ...
      <div class="sidebar__section">Stránky</div>
      <a href="/admin/content-index.php" class="sidebar__link <?= $activeLink === 'content-index' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Úvodní stránka
      </a>
      <a href="/admin/content-advokatni.php" class="sidebar__link <?= $activeLink === 'content-advokatni' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Advokátní úschova
      </a>
      <a href="/admin/content-typy.php" class="sidebar__link <?= $activeLink === 'content-typy' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Typy úschov
      </a>
      <a href="/admin/content-rady.php" class="sidebar__link <?= $activeLink === 'content-rady' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Rady a pojmy
      </a>
      <a href="/admin/content-kontakty.php" class="sidebar__link <?= $activeLink === 'content-kontakty' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Kontakty
      </a>
      <a href="/admin/content-footer.php" class="sidebar__link <?= $activeLink === 'content-footer' ? 'active' : '' ?>">
        <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><line x1="4" y1="9" x2="20" y2="9"/></svg>
        Patička
      </a>
