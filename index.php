...
<section class="hero" aria-label="Úvod">
  <div class="hero__image-side">
    <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1920&q=80" alt="Klíče od nemovitosti" loading="eager">
  ...
  <div class="hero__content-side">
    <div class="container">
      ...
      <div class="hero__cta">
        ...
        <a href="/advokatni-uschova.php" class="btn btn--outline-white">Advokátní úschova</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="values__grid">
      <div class="value-card fade-in">
        <div class="value-card__icon"><svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
        <div class="value-card__title">Bezpečné uložení financí</div>
        <p>Na samostatném úschovním účtu, odděleném od jiných prostředků.</p>
      </div>
      <div class="value-card fade-in">
      ...
      <div class="value-card fade-in">
        ...
        <div class="value-card__title">Rovnováhu a důvěru</div>
        <p>Mezi smluvními stranami po celou dobu transakce.</p>
      </div>
      <div class="value-card fade-in">
        <div class="value-card__icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M9 12l2 2 4-4"/></svg></div>
        <div class="value-card__title">Ochranu po celou dobu</div>
        <p>Od podpisu smlouvy až po samotný převod.</p>
      </div>
    </div>
    <div style="text-align:center;margin-top:3rem;">
      <a href="/advokatni-uschova.php" class="btn btn--outline">Vše o advokátní úschově</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="about__grid">
      ...
      <div class="about__image fade-in">
        <img src="https://images.unsplash.com/photo-1554469384-e58fac16e23a?auto=format&fit=crop&w=1200&q=80" alt="Konzultace advokátní úschovy">
