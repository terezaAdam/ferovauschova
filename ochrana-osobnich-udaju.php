<?php
$pageTitle = 'Zásady ochrany osobních údajů – Férová úschova';
$pageDesc  = 'Informace o zpracování osobních údajů podle čl. 13 nařízení GDPR.';
include __DIR__ . '/includes/header.php';
?>

<section class="page-hero">
  <div class="container">
    <p class="page-hero__label">GDPR</p>
    <h1 class="page-hero__title">Zásady ochrany osobních údajů</h1>
    <p class="page-hero__desc">Informace o zpracování osobních údajů podle čl. 13 nařízení GDPR.</p>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="article-body">
      ...
      <p>Zpracováváme osobní údaje, které nám sami poskytnete, zejména prostřednictvím kontaktního formuláře na našich webových stránkách, e-mailem, telefonicky nebo v souvislosti s poskytováním právních služeb a advokátní úschovy.</p>
      ...
      <ul>
        ...
        <li>údaje uvedené v kontaktním formuláři, zejména obsah zprávy a popis vaší situace;</li>
        <li>další údaje, které nám sami v rámci svého dotazu nebo následné komunikace sdělíte;</li>
        <li>v případě navázání spolupráce další identifikační, kontaktní a případové údaje nezbytné pro poskytování advokátní úschovy;</li>
      ...
      <p>Vzhledem k povaze advokátní úschovy může obsah komunikace v jednotlivých případech zahrnovat také citlivější informace, například údaje o transakci nebo výši uschovávaných prostředků. Takové údaje zpracováváme pouze v rozsahu nezbytném pro vyřízení dotazu, posouzení případu nebo poskytnutí úschovy a v souladu s příslušnými právními předpisy.</p>
      ...
      <ul>
        ...
        <li>posouzení možnosti poskytnutí advokátní úschovy;</li>
        <li>jednání o uzavření smlouvy o advokátní úschově;</li>
        <li>uzavření a plnění smlouvy o advokátní úschově;</li>
      ...
      <ul>
        <li>provedení opatření na vaši žádost před uzavřením smlouvy a plnění smlouvy podle čl. 6 odst. 1 písm. b) GDPR, zejména pokud nás kontaktujete s poptávkou advokátní úschovy nebo pokud vám již úschovu poskytujeme;</li>
      ...
      <p>Pokud dojde k uzavření smlouvy o advokátní úschově, uchováváme osobní údaje po dobu trvání úschovy a následně po dobu vyžadovanou příslušnými právními předpisy a stavovskými předpisy České advokátní komory, případně po dobu nezbytnou k ochraně a uplatňování našich právních nároků.</p>
      ...
      <ul>
        ...
        <li>banka, u které je veden úschovní účet;</li>
      ...
      <p>Pokud s námi uzavřete smlouvu o advokátní úschově, může být poskytnutí některých osobních údajů nezbytné pro uzavření nebo plnění smlouvy nebo pro splnění našich zákonných povinností.</p>
